...
print ("RL_init called, the environment sent task spec: " + str(taskSpec))

print ("\n\n----------Sending some sample messages----------")

#Talk to the agent and environment a bit...*/
responseMessage = RLGlue.RL_agent_message("what is your name?")
print ("Agent responded to \"what is your name?\" with: " + str(responseMessage))

responseMessage = RLGlue.RL_agent_message("If at first you don't succeed; call it version 1.0")
print ("Agent responded to \"If at first you don't succeed; call it version 1.0  \" with: " + str(responseMessage) + "\n")

responseMessage = RLGlue.RL_env_message("what is your name?")
print ("Environment responded to \"what is your name?\" with: " + str(responseMessage))
responseMessage = RLGlue.RL_env_message("If at first you don't succeed; call it version 1.0")
print ("Environment responded to \"If at first you don't succeed; call it version 1.0  \" with: " + str(responseMessage))
